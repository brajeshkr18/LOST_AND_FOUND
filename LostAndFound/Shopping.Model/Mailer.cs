...
namespace Shopping.Model
{
    ...
    //        }
    //    }
    //    public bool SendContactMailOnCallCreation(string To, string Name, string RequesterMail, string subject, string from, string contact, string message, string CC, string BCC, bool enableSsl, string filePath)
    //    {
    //        try
    //        {
